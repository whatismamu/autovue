                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item
                                label="终端号："
                                prop="termid">
                                <el-input v-model="dialogForm.termid"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item
                                label="商户编号："
                                prop="MERC_NO">
                                <el-input v-model="dialogForm.MERC_NO"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item
                                label="注册账号："
                                prop="REG_USER_NO">
                                <el-input v-model="dialogForm.ENC_REG_USER_NO"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item
                                label="机构id："
                                prop="AGENT_ID">
                                <el-input v-model="dialogForm.AGENT_ID"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
