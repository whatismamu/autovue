export default {
    ...
    methods: {
        ...
        showDialog(type) {
            if (type === 0) {
                ...
                if (this.selectedRow !== '') {
                    ...
                    this.dialogForm['MERC_NO'] = this.selectedRow['MERC_NO'];
                    this.dialogForm['REG_USER_NO'] = this.selectedRow['REG_USER_NO'];
                    this.dialogForm['ENC_REG_USER_NO'] = this.selectedRow['ENC_REG_USER_NO'];
                    this.dialogForm['AGENT_ID'] = this.selectedRow['AGENT_ID'];
        ...
        initPageData() {
            ...
            console.log(66666);
            console.log(token);
            this.$http.initPageData('/epos/EposSearchShop/', this);
        },
