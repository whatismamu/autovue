export default {
    ...
    data() {
        return {
            ...
            selectedRow: '',
            odList:[{odName:'dzgp'},{odName:'jsdp'}],
            odList1:[{odName:'dgj'},{odName:'sxzs'},{odName:'jsd'}],
            termTypeList:'',
            deviceActivity:''
        }
    },
    ...
    methods: {
        ...
        queryDevActivity(row) {
            this.$http.post({
                url: '/dgj/DgjDeviceActivityList/',
                data: {
                    devno:row.DEV_NO,
                    orgid:row.ORG_ID
                }
            ...
            if (type === 0) {
                ...
                if (this.selectedRow !== '') {
                    ...
                    this.$http.post({
                        url: '/dgj/DgjDeviceActivityList/',
                        data: {
                            devno:this.selectedRow['DEV_NO'],
                            orgid:this.selectedRow['ORG_ID']
                        }
                    }).then(res => {
                        if (res.data.result) {
                    ...
                    this.dialogForm['deviceActivity'] = this.deviceActivity['deviceactivityName'];
        ...
        initPageData() {
            ...
            console.log(66666);
            console.log(token);
            this.$http.initPageData('/dgj/DzgTerm/', this);
        },
