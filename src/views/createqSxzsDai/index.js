    ...
    methods: {
        ...
        formatterIsAuth(row, cloumn) {
            ...
            if (row.CHECK_STATUS === '01') {
                ...
                if (row.CHECK_STATUS === '02'){
                    return '退回';
                }
                if (row.CHECK_STATUS === '00'){
                    return '审核通过';
                }
                else{
                    return '未认证';
            ...
            this.$confirm('确认通过?', '提示', {
              ...
              type: 'warning'
                ...
                this.$http.post({
                    ...
                    if (!res['data']['message'] || res['data']['meta']['statusCode'] ===200)
                    {
                        console.log(200);
                    // this.$alert('操作成功', '提示', {
                    //     confirmButtonText: '确定',
        ...
        initPageData() {
            ...
            console.log(66666);
            console.log(token);
            this.$http.initPageData('/sxzs/SxzsDaiLi/', this);
        },
